...
public class helper
{
	public static String[] parseSeqs(String file) throws IOException {
	...
	public int[][] parseMatrixFile(String file) throws IOException {
	...
	public char[] readAsCharArray(String file) throws IOException {
        return readAsString(file).toCharArray();
    }
    ...
    public static String[] ids(String file) throws IOException {
    	return lines(file)
